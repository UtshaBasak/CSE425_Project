...
Updated 2026-09-06 11:40. **15 done, 5 failed, 6 remaining.**

Estimated **0.6 h** of local GPU left, from 14 measured step(s) (estimates running 0.41x of prediction).
...
| report fill + structural check | C7 | [~] | running |
